...
const G2_GENERATOR_X_C0: Fp = Fp::from_raw_unchecked([
...
const G2_GENERATOR_X_C1: Fp = Fp::from_raw_unchecked([
...
const G2_GENERATOR_Y_C0: Fp = Fp::from_raw_unchecked([
...
const G2_GENERATOR_Y_C1: Fp = Fp::from_raw_unchecked([
...
impl G2Projective {
    ...
    pub fn double(&self) -> G2Projective {
        ...
        // let x0 = self.x * self.z;
        // let y0 = self.y * self.z.square();
        // let z0 = self.z;
        ...
        // // D = 2*((X1+B)2-A-C)
        // let mut d = ((x0 + b).square() - a - c).double();
        ...
        // // Y3 = E*(D-X3)-8*C
        // let y3 = e * (d - x3) - c.double().double().double() - c;
...
fn test_clear_cofactor_b() {
    ...
    for _ in 0..32 {
        let input = G2Projective::random(&mut rng);
        assert_eq!(input.clear_cofactor(), input.multiply(&h_eff_modq));
    }
}
